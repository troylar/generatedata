	...
	<div id="gdGenerateSubtab1">
		...
		<div id="gdGenerateSection">
			...
			<span>
				...
				<input type="radio" name="gdExportTarget" id="gdExportTarget_uploadToS3" value="uploadToS3" />
					<label for="gdExportTarget_uploadToS3" id="gdExportTarget_uploadToS3_label">{$L.upload_to_s3}</label>
